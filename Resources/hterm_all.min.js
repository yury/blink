...
$jscomp.polyfill("Object.assign",function(a){return a||$jscomp.assign},"es6","es3");function _reattachNode(a){var b=a.parentNode,c=a.nextSibling;b&&(b.removeChild(a),b.insertBefore(a,c))}
function setNodeText(a,b,c){a.textContent=b;a.nodeType===Node.TEXT_NODE?_reattachNode(a):("undefined"===typeof c&&(c=b.length)&&!a.asciiNode&&(c=lib.wc.strWidth(b)),b=a._len,b!==c&&(void 0===b&&(a.style.display="inline-block",a.style.overflowX="hidden"),a.style.width="calc(var(--hterm-charsize-width) * "+c+")",a._len=c))}if("undefined"!=typeof lib)throw Error('Global "lib" object already exists.');
...
e)),this.cursorOffset_+=b):0==e?(g=c.previousSibling)&&this.textAttributes.matchesContainer(g)?(setNodeText(g,g.textContent+a),this.cursorNode_=g,this.cursorOffset_=lib.wc.strWidth(g.textContent)):(a=this.textAttributes.createContainer(a,b),this.cursorRowNode_.insertBefore(a,c),this.cursorNode_=a,this.cursorOffset_=b):0==g?(c=c.nextSibling)&&this.textAttributes.matchesContainer(c)?(setNodeText(c,a+c.textContent),this.cursorNode_=c,this.cursorOffset_=lib.wc.strWidth(a)):(a=this.textAttributes.createContainer(a,
b),this.cursorRowNode_.insertBefore(a,c),this.cursorNode_=a,this.cursorOffset_=hterm.TextAttributes.nodeWidth(a)):(this.splitNode_(c,e),a=this.textAttributes.createContainer(a,b),this.cursorRowNode_.insertBefore(a,c.nextSibling),this.cursorNode_=a,this.cursorOffset_=b)};
...
hterm.TextAttributes.prototype.createContainer=function(a,b){if(this.isDefault())return this.document_.createTextNode(a);var c=this.document_.createElement("span"),d=c.style,e=[];this.foreground!=this.DEFAULT_COLOR&&(d.color=this.foreground);this.background!=this.DEFAULT_COLOR&&(d.backgroundColor=this.background);this.enableBold&&this.bold&&(d.fontWeight="bold");this.faint&&(c.faint=!0);this.italic&&(d.fontStyle="italic");this.blink&&(e.push("blink-node"),c.blinkNode=!0);var g="";if(c.underline=this.underline)g+=
" underline",d.textDecorationStyle=this.underline;this.underlineSource!=this.SRC_DEFAULT&&(d.textDecorationColor=this.underlineColor);this.strikethrough&&(g+=" line-through",c.strikethrough=!0);g&&(d.textDecorationLine=g);this.wcNode&&(e.push("wc-node"),c.wcNode=!0);c.asciiNode=this.asciiNode;null!=this.tileData&&(e.push("tile"),e.push("tile_"+this.tileData),c.tileNode=!0);a&&setNodeText(c,a,b);this.uri&&(e.push("uri-node"),c.uriId=this.uriId,c.title=this.uri,c.addEventListener("click",hterm.openUrl.bind(this,
this.uri)));e.length&&(c.className=e.join(" "));return c};
...
this.DEFAULT_COLOR?this.defaultForeground:this.foreground,"rgb(0, 0, 0)",.3333));b==this.SRC_DEFAULT?this.background=d:Number.isInteger(b)?this.background=this.colorPalette[b]:this.background=b;this.invisible&&(this.foreground=this.background);this.underlineSource==this.SRC_DEFAULT?this.underlineColor=void 0:Number.isInteger(this.underlineSource)?this.underlineColor=this.colorPalette[this.underlineSource]:this.underlineColor=this.underlineSource};
...
hterm.VT.prototype.parseUnknown_=function(a){function b(a){!c.codingSystemUtf8_&&c[c.GL].GL&&(a=c[c.GL].GL(a));c.terminal.print(a)}var c=this,d=a.peekRemainingBuf(),e=d.search(this.cc1Pattern_);0==e?(this.dispatch("CC1",d.substr(0,1),a),a.advance(1)):-1==e?(b(d),a.reset()):(b(d.substr(0,e)),this.dispatch("CC1",d.substr(e,1),a),a.advance(e+1))};function finishParsing_(a){a.resetArguments();a.subargs=null;a.resetParseFunction()}
hterm.VT.prototype.parseCSI_=function(a){var b=a.peekChar(),c=a.args;"@"<=b&&"~">=b?(this.dispatch("CSI",this.leadingModifier_+this.trailingModifier_+b,a),finishParsing_(a)):";"==b?this.trailingModifier_?finishParsing_(a):(c.length||c.push(""),c.push("")):"0"<=b&&"9">=b||":"==b?this.trailingModifier_?finishParsing_(a):(c.length?c[c.length-1]+=b:c[0]=b,":"==b&&a.argSetSubargs(c.length-1)):" "<=b&&"?">=b?c.length?this.trailingModifier_+=b:this.leadingModifier_+=b:this.cc1Pattern_.test(b)?this.dispatch("CC1",
b,a):finishParsing_(a);a.advance(1)};
...
hterm.VT.CC1["\u0096"]=hterm.VT.ESC.V=hterm.VT.ignore;hterm.VT.CC1["\u0097"]=hterm.VT.ESC.W=hterm.VT.ignore;hterm.VT.CC1["\u0098"]=hterm.VT.ESC.X=hterm.VT.ignore;hterm.VT.CC1["\u009a"]=hterm.VT.ESC.Z=function(){this.terminal.io.sendString("\u001b[?1;2c")};hterm.VT.CC1["\u009b"]=hterm.VT.ESC["["]=function(a){a.resetArguments();this.trailingModifier_=this.leadingModifier_="";a.func=this.parseCSI_};hterm.VT.CC1["\u009c"]=hterm.VT.ESC["\\"]=hterm.VT.ignore;var parseOSCReg_=/^(\d+);(.*)$/;
function parseOSC_(a){if(this.parseUntilStringTerminator_(a)&&a.func!==parseOSC_){var b=a.args[0].match(parseOSCReg_);b?(a.args[0]=b[2],this.dispatch("OSC",b[1],a)):console.warn("Invalid OSC: "+JSON.stringify(a.args));a.resetArguments()}}hterm.VT.CC1["\u009d"]=hterm.VT.ESC["]"]=function(a){a.resetArguments();a.func=parseOSC_};hterm.VT.CC1["\u009e"]=hterm.VT.ESC["^"]=function(a){a.resetArguments();a.func=this.parseUntilStringTerminator_};
hterm.VT.CC1["\u009f"]=hterm.VT.ESC._=function(a){a.resetArguments();a.func=this.parseUntilStringTerminator_};hterm.VT.ESC[" "]=function(a){a.func=function(a){var b=a.consumeChar();this.warnUnimplemented&&console.warn("Unimplemented sequence: ESC 0x20 "+b);a.resetParseFunction()}};hterm.VT.ESC["#"]=function(a){a.func=function(a){"8"==a.consumeChar()&&this.terminal.fill("E");a.resetParseFunction()}};
